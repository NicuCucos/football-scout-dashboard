...
export const WatchlistCard: FC<Props> = ({
    entry,
    isRemoving,
    onEditNotes,
    onRemove,
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
            ...
            <div className="mt-3 flex gap-2">
                ...
                <button
                    onClick={onRemove}
                    disabled={isRemoving}
                    className="flex-1 rounded-xl border border-white/10 bg-red-500/10 px-3 py-2 text-sm hover:bg-red-500/20 disabled:cursor-not-allowed disabled:opacity-50"
                >
